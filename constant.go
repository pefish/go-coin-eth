...
var (
	...
	MaxUint160, _ = new(big.Int).SetString("000000000000000000000000ffffffffffffffffffffffffffffffffffffffff", 16)

	// solidity 中的 struct ，在 ABI 中的类型都是 tuple，字段的顺序就是 tuple 中元素的顺序
	...
	TypeUint24, _     = abi.NewType("uint24", "", nil)
	...
	TypeBytesSlice, _ = abi.NewType("bytes[]", "", nil)
